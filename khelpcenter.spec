...
Version  : 25.04.2
Release  : 85
URL      : https://download.kde.org/stable/release-service/25.04.2/src/khelpcenter-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/khelpcenter-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/khelpcenter-25.04.2.tar.xz.sig
...
%setup -q -n khelpcenter-25.04.2
cd %{_builddir}/khelpcenter-25.04.2
pushd ..
cp -a khelpcenter-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749524218
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libexec/khc_mansearch.py
...
%files locales -f khelpcenter6.lang
%defattr(-,root,root,-)
