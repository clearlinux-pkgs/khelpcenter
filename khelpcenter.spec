...
Source0  : https://download.kde.org/stable/release-service/24.12.0/src/khelpcenter-24.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.0/src/khelpcenter-24.12.0.tar.xz.sig
...
%setup -q -n khelpcenter-24.12.0
cd %{_builddir}/khelpcenter-24.12.0
pushd ..
cp -a khelpcenter-24.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735266247
mkdir -p clr-build
pushd clr-build
