...
Version  : 19.12.0
Release  : 16
URL      : https://download.kde.org/stable/release-service/19.12.0/src/khelpcenter-19.12.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.0/src/khelpcenter-19.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.0/src/khelpcenter-19.12.0.tar.xz.sig
...
%prep
%setup -q -n khelpcenter-19.12.0
cd %{_builddir}/khelpcenter-19.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576554820
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khelpcenter-19.12.0/COPYING %{buildroot}/usr/share/package-licenses/khelpcenter/8cf4afb0636055f7cacd1b6955e0e8ebec7888f5
pushd clr-build
%make_install
popd
