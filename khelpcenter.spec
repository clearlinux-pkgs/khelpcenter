...
Source0  : https://download.kde.org/stable/release-service/20.12.3/src/khelpcenter-20.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.3/src/khelpcenter-20.12.3.tar.xz.sig
...
%prep
%setup -q -n khelpcenter-20.12.3
cd %{_builddir}/khelpcenter-20.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618674438
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/khelpcenter-20.12.3/COPYING %{buildroot}/usr/share/package-licenses/khelpcenter/8cf4afb0636055f7cacd1b6955e0e8ebec7888f5
pushd clr-build
%make_install
popd
