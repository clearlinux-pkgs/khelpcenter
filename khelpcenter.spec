...
Source0  : https://download.kde.org/stable/release-service/22.12.1/src/khelpcenter-22.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.1/src/khelpcenter-22.12.1.tar.xz.sig
...
%prep
%setup -q -n khelpcenter-22.12.1
cd %{_builddir}/khelpcenter-22.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673312363
mkdir -p clr-build
pushd clr-build
